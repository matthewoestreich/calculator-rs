...
impl FromStr for Value {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        s.parse::<u128>()
            ...
            .or_else(|_| s.parse::<i64>().map(|i| Self::SignedInt(i as _)))
...
mod test {
    ...
    fn try_from() {
        ...
        test_try_from!(u128, u128::MAX, UnsignedInt);
        test_try_from!(i64, i64::MIN, SignedInt);
        test_try_from!(i128, i128::MIN, SignedInt);
    ...
    fn from_str() {
        ...
        test_from_str!("-11.2" => Value::Float(-11.2));
        test_from_str!("18446744073709551615" => Value::UnsignedInt(u64::MAX as _));
        //test_from_str!("340282366920938463463374607431768211455" => Value::UnsignedBigInt(u128::MAX));
        test_from_str!("340282366920938463463374607431768211455" => Value::UnsignedInt(u128::MAX));
        test_from_str!("-9223372036854775808" => Value::SignedInt(i64::MIN as _));
        test_from_str!("-170141183460469231731687303715884105728" => Value::SignedInt(i128::MIN));
